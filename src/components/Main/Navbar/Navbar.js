...
const Navbar = (props) => {
  return (
    <div className="w-full py-3 px-6 fixed top-0 left-0 right-0 bg-gradient-to-b from-primaryPurple to-secondaryPurple flex justify-end items:center lg:bg-gradient-to-b lg:from-transparent lg:to-transparent lg:bg-[rgba(0,0,0,.2)] ">
